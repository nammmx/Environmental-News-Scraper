...
if ENV =="dev":
  ...
  app.debug = False
  #production database
  app.config["SQLALCHEMY_DATABASE_URI"] = "postgres://uzuoiahizbsrwy:abd5d4a33f4af77569693171f721d5d08f45ecdda99604e00f46027ce8b3a1a3@ec2-54-211-77-238.compute-1.amazonaws.com:5432/d4hqlsiop6h904"
...
#THIS WORKS!!!! NOW FIGURE OUT HOW TO NOT RUN IT TWICE EVERYTIME AND HOW TO DELETE JOBS AND HOW TO DELETE DEPLOYS ON HEROKU AND WHY GUARDIAN IS NOT WORKING
if not app.debug or os.environ.get('WERKZEUG_RUN_MAIN') == 'true':
  sched = BackgroundScheduler(daemon=True)
  sched.add_jobstore('sqlalchemy', url='postgres://uzuoiahizbsrwy:abd5d4a33f4af77569693171f721d5d08f45ecdda99604e00f46027ce8b3a1a3@ec2-54-211-77-238.compute-1.amazonaws.com:5432/d4hqlsiop6h904')
